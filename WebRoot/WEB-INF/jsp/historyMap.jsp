       ...
       <!--  <div class="map_search">
                    ...
                    <div class="map_right">
                        <div class="map_top">
                            ...
                            <a class="pull-right" data-toggle="modal" href="#history" data-backdrop="static"><i class="glyphicon glyphicon-th-list"></i></a>
                        </div>
                        <div class="map_dev_list">
                            <ul class="bxslider map_dev">
	                    ...
	                    <div class="form-group">
	                        ...
	                        <div class="col-md-8">
	                            <div class="input-icon">
	                                ...
	                                <input id="histroyCheck" type="text" class="form-control input-large" placeholder="请输入设备号">
	                            </div>
	                        </div>
	                    </div>
	                </form>
