...
<body onload="alarmOnload('thing');">
<div class="o_warpper" >
    <!-- BEGIN HEADER -->
    <div class="o_header">
        <a href="javascript:void(0)" class="top_back" onclick="window.location.href='../../web/pageController/toIndex'"><span class="icon-arrow-left"></span>事件</a>
        <ul class="o_topnav">
            <li >
